...
<body>
    ...
    <div class="signup">
        <form action="signup.php" method="post" onSubmit = "return check(this)">
            ...
            <input type="text" name="name" placeholder="Enter Name" size=47 required autocomplete="off">
            ...
            <a href="index.html"onclick="location.href='login.html'">Already have an account?</a>
        </form>
    </div>
